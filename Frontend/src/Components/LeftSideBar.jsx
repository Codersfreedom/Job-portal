...
const LeftSideBar = () => {
    ...
    return (
        <aside className='leftside  bg-white h-36 w-screen   flex-col   md:h-[calc(100vh-64.8px)] md:w-16 md:border-r shadow-lg justify-start items-center  py-10' >
